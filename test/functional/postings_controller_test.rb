...
class PostingsControllerTest < ActionController::TestCase
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post :create, posting: { body: @posting.body, photos_count: @posting.photos_count, title: @posting.title }
    end
  ...
  test "should update posting" do
    put :update, id: @posting, posting: { body: @posting.body, photos_count: @posting.photos_count, title: @posting.title }
    assert_redirected_to posting_path(assigns(:posting))
  end
